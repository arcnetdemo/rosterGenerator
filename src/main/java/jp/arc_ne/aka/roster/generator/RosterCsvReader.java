...
import jp.arc_ne.aka.roster.dto.RosterHeaderInfo;
import jp.arc_ne.aka.roster.dto.RosterInfo;
import jp.arc_ne.aka.roster.dto.RosterRowInfo;
import jp.arc_ne.aka.roster.util.EmptyFalseFormat;
...
public class RosterCsvReader {
	...
	public RosterCsvReader() {
		...
		templateRow.column("date").column("details")
				...
				.column("extraMinutes").column("intervalMinutes").column("remarks");
	}
